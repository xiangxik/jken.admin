...
public class CoreModuleIntegration extends AbstractModuleIntegration {
    ...
    public void integrate(ModuleMetadata metadata) {
        ...
        decorator.domain("公司", "corp")
                .addAuthority("公司查看", "corp-view-info", new String[]{"/corp/info"}, Authority.PatternType.ANT, HttpMethod.GET)
                .addAuthority("公司编辑", "corp-edit-info", new String[]{"/corp/info"}, Authority.PatternType.ANT, HttpMethod.PUT);
